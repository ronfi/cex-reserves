...
2. **HTX 自报储备率"均超 100%",但按链上可核口径:USDT 自有钱包只覆盖负债的 4.8%,BTC 42%,ETH 25%;总储备的 18.1% 在不披露身份的"第三方托管",47.5% 是 TRX 且其中 69% 处于质押。**(自报数为 2026-09-01 页面快照,链上数为 09-07 直读)
3. Binance / OKX 的储备在 ETH 链上可 95–99% 对上;Bitfinex、Gate、KuCoin、Gemini 在 98–101%;BTC 链十一所全部对上(差 ≤1.0%)。各所均自报储备率 >100%;本报告只能核验其中可在链上读到的部分,各所可核比例见 §3。
